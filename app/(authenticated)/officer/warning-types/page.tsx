...
import { ImportWarningTypesModal } from '../../../../components/ImportWarningTypesModal';
...
export default function WarningTypesPage() {
  ...
  return (
    <div>
      ...
      <div className="flex items-center justify-between mb-6">
        ...
        <div className="flex gap-2">
          <button
            ...
            className="px-4 py-2 bg-gray-600 hover:bg-gray-500 disabled:opacity-50 disabled:cursor-not-allowed rounded transition-colors font-semibold"
          >
            Import CSV
          </button>
          <button
      ...
      {/* Import CSV Modal */}
      <ImportWarningTypesModal
        isOpen={importModalOpen}
        onClose={() => setImportModalOpen(false)}
        guildId={selectedPlayer.guildId}
        existingTypes={warningTypes}
